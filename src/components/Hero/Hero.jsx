    ...
    style={{ 
        ...
        <div class="lg:container flex flex-col items-center selection:md:items-right w-full md:flex-row z-10 justify-center md:justify-end text-center md:text-end">
            <div class="max-w-[400px] md:max-w-[450px] xl:max-w-[800px] md:p-12 xl:p-24">
                <h1 class="text-3xl font-medium tracking-wide text-white md:text-4xl text-antiquewhite">Найкращій відпочинок у лазні</h1>
                <p class="mt-4 text-white">У спа-готелі 'Баня на Озері' вас чекає атмосфера справжнього відпочинку. Лазня на дровах, гарячі чани з травами, зручні готельні номери та паркувальні місця - все для вашого комфорту. А пляжна зона з чистою річкою створює неповторне враження для сімейного відпочинку або зустрічі з друзями. Дозвольте собі цю насолоду у 'Бані на Озері'.
</p>
                <div class="mt-6">
