...
export const Review = ({review}) => {
  ...
  return (
    ...
    <div onClick={() => setShowPicture(false)}>
        <div class={`flex flex-col text-darkBrown bg-[#f1d8cde3] md:bg-lightBrown p-4  rounded-2xl max-h-[400px] absolute z-10 bottom-[-20px] right-0 w-[80%] md:min-w-[500px]  md:w-[60%] xl:w-[500px] md:right-[100px] xl:right-[30%] ${showPicture && "opacity-30"} transition-all shadow-md`}>
        <div>
