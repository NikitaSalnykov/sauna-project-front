...
export const SecondaryHero = ({img, title, link, linkName}) => {
  return (
    <div class="flex flex-col pt-24 pb-8 px-6 h-[220px] md:h-[300px] md:py-12 md:flex-row md:items-center md:space-x-6 bg-cover bg-center bg-no-repeat bg-black justify-center item-center md:justify-start xl:justify-center relative"  
    style={{ 
